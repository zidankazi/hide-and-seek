...
# ---- config ----
SAVE_PREFIX = "hs_roomt"                      # NOTE: distinct prefix — never clobbers hs_lstm_* / hs_lstmrc*
...
print(f"[roomt] layout={LAYOUT} DOOR_Y={DOOR_Y} FAR_Y={FAR_Y} | {N_ENVS} envs x {STEPS_PER_ENV} = "
      f"{N_ENVS*STEPS_PER_ENV}/update | obs={obs_dim} steps={TOTAL_TIMESTEPS} rc_end={RC_END} hidden={HIDDEN}")
