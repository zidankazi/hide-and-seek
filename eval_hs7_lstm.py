...
from ppo_recurrent import ActorCriticLSTM
...
def reset_hidden():
    for name in env.possible_agents:
        _hc[name] = nets[env.team[name]].init_hidden()
...
print(f"Stage 7 LSTM eval ({N} eps, room 1v2 + ramp, weights={PREFIX}_*{SUFFIX}.pt):")
